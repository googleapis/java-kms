...
[google-cloud-java/java-kms](
https://github.com/googleapis/google-cloud-java/tree/main/java-kms).
...
```Groovy
implementation 'com.google.cloud:google-cloud-kms:2.13.0'
```

If you are using SBT, add this to your dependencies:

```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-kms" % "2.13.0"
```
